...
We will now copy this across to `exercise_01/`, modify it, and run it to save our code to
TorchScript.
...
This is done in exactly the same way as you would compile and link to any other library,
for example NetCDF.
...
In reality, however, we would use a `Makefile` or CMake.
examples of both of these are included.
